...
public class GeneralMovieEntity extends RealmObject {

    public static final String KEY_MOVIE = "GeneralMovieEntity";
    ...
    public GeneralMovieEntity() {
    }

    public GeneralMovieEntity(ResponseMovie movie, int service) {
        this.id = movie.getId();
