...
public class TopRatedMovieEntity extends RealmObject {

    public static final String KEY_MOVIE = "TopRatedMovieEntity";
    ...
    public TopRatedMovieEntity() {
    }

    public TopRatedMovieEntity(ResponseMovie movie, int service) {
        this.id = movie.getId();
